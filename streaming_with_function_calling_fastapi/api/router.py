...
from streaming_with_function_calling_fastapi.services.chat import ChatService
from streaming_with_function_calling_fastapi.utils.stream import stream_generator

api_router = APIRouter()
chat_service = ChatService()

templates = Jinja2Templates(directory="streaming_with_function_calling_fastapi/templates")
