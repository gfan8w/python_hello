...
from streaming_with_function_calling_fastapi.config.prompts import SYS_PROMPT
from streaming_with_function_calling_fastapi.utils.singleton import Singleton
from streaming_with_function_calling_fastapi.services.assistant_setup import AssistantSetup
from streaming_with_function_calling_fastapi.tools.definitions import GET_WEATHER_INFORMATION
from streaming_with_function_calling_fastapi.tools.get_weather import get_weather_information
...
class ChatService(metaclass=Singleton):
    ...
    def __init__(self) -> None:
        self.client = OpenAI(api_key=os.environ["OPENAI_API_KEY"], base_url="https://dashscope.aliyuncs.com/compatible-mode/v1")
